...
class CalendarApp extends Component {
    ...
    render()
    {
        const {classes, openNewEventDialog, openEditEventDialog} = this.props;
...
{
    return {
        entities: calendarApp.events.entities,
    }
}

export default withReducer('calendarApp', reducer)(withStyles(styles, {withTheme: true})
