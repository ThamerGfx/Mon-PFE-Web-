...
const mapStateToProps = ({calendarApp}) =>
{
    return {
...
export default connect(mapStateToProps, {closeEditEventDialog, closeNewEventDialog, addEvent, updateEvent, removeEvent})(EventDialog);
